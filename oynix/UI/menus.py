"""
OyNIx Browser v2.3 - Menu System
...
class OynixMenuBar:
    ...
    def _file_menu(self):
        ...
        imp.addSeparator()
        self._a(imp, "OyNIx Profile (.nydta)...", self.b.import_nydta)
        ...
        exp.addSeparator()
        self._a(exp, "Full Profile (.nydta)...", self.b.export_nydta)
        m.addSeparator()
        self._a(m, "Set Profile Picture...", self.b.set_profile_picture)
        m.addSeparator()
    ...
    def _tools_menu(self):
        ...
        self._a(prof, "Manage Profiles", self.b.show_profiles)
        self._a(prof, "New Profile...", self.b.create_profile)
        self._a(prof, "Switch Profile...", self.b.switch_profile)
        self._a(prof, "Delete Profile...", self.b.delete_profile)
        prof.addSeparator()
